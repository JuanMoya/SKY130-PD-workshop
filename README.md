...
![Docker command](/Day1_images/step_1.png)
We use the "docker" command to invoke openlane.

![./flow.tcl -interactive command to run the OpenLANE flow.](/Day1_images/step_2.png)
We type the "./flow.tcl - interactive" command to run the openLANE flow.

![package require openlane 0.9 command to load all the packages needed.](/Day1_images/step_3.png)
...
![prep -design picorv32 command to prepare the design setup stage.](/Day1_images/step_4.png)
We prepare the design setup stage with thrv32a-e command "prep -design picorv32a"

![We check the created files.](/Day1_images/step_5.png)
![We check the temp directory and the files created inside.](/Day1_images/step_6.png)
Then, we review the files after design preparation and run synthesis.

![We run the synthesis.](/Day1_images/step_7.png)
Then, we type the "run_synthesis" command.

![Synthesis successfull.](/Day1_images/step_8.png)
We observe that the synthesis is completed successfully.

![Flop ratio.](/Day1_images/step_9.png)
...
![Track information of the different layers.](/Day4_images/Day4_1.png)
We observe the file associated to the tracks.

![Grid set according to the track infomation.](/Day4_images/Day4_2.png)
...
![Copy of the inverter file.](/Day4_images/Day4_3.png)
We make a copy of the inverter file to  incorporate in the physical design flow.

![We open the inverter file.](/Day4_images/Day4_4.png)
We open the copied file to verify that it is ok.

![LEF file created.](/Day4_images/Day4_5.png)
We create the LEF file.

![LEF file verification.](/Day4_images/Day4_6.png)
We verify that the LEF file is created.

![LEF file information.](/Day4_images/Day4_7.png)
We open the LEF file.

![Copied files in the src folder.](/Day4_images/Day4_9.png)
We copy the .lef and libraries in the src file to be part of the flow.

Then, we modify the config.tcl.

![Before modifications.](/Day4_images/Day4_10.png)
The config.tcl before modifications.

![After modifications.](/Day4_images/Day4_11.png)
The config.tcl after modifications.

![We run openLANE again with our cell.](/Day4_images/Day4_12.png)
We run the openLANE flow and we overwrite the last folder generated by the synthesis.

![We include the two lines.](/Day4_images/Day4_13.png)
...
![Synthesis was successful.](/Day4_images/Day4_14.png)
We observe that the synthesis was successful.

![tns and wns values.](/Day4_images/Day4_15.png)
We observe the tns and wns values.

![Current chip area.](/Day4_images/Day4_15a.png)
The current chip area is 147712.918400 um2.

![Variable modifications.](/Day4_images/Day4_16.png)
Then we define the variables to change strategy.

![Skipping synthesis.](/Day4_images/Day4_17.png)
We rerun the synthesis but there already exists the ".synthesis.v" file.

![Renaming old "synthesis.v" file.](/Day4_images/Day4_18.png)
I rename the ".synthesis.v" file to avoid conflicts.

![Error with the "::env(SYNTH_STRATEGY)" variable definition.](/Day4_images/Day4_19.png)
I rerun the synthesis but I got an error since the "::env(SYNTH_STRATEGY)" was not correctly defined.

![Correct definition of the "::env(SYNTH_STRATEGY)" variable.](/Day4_images/Day4_20.png)
I correctly define "::env(SYNTH_STRATEGY)".

![Synthesis successful.](/Day4_images/Day4_21a.png)
Then I rerun the synthesis and it was successful.

![New area for the new strategy.](/Day4_images/Day4_22.png)
The new area is 209181.872000 um2.

![Placement command error.](/Day4_images/Day4_23.png)
